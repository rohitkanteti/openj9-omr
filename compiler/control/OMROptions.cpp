...
TR::OptionTable OMR::Options::_jitOptions[] = {
   ...
   {"enableSmarterAOTCompile",       "O\tenable my(Rohit's)  analysis pass for Escape status based validation of AOT code compilation",   SET_OPTION_BIT(TR_RunMyAnalysis), "F"},
   {"enableSmarterAOTLoad",       "O\tenable my(Rohit's)  analysis pass for Escape status based validation of AOT code load",   SET_OPTION_BIT(TR_smartAOTLoad), "F"},
